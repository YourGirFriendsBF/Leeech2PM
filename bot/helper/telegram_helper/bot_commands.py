...
class _BotCommands:
    def __init__(self):
        ...
        self.WatchCommand = f'watch69'
        self.ZipWatchCommand = f'zipwatch69'
        self.QbMirrorCommand = f'qbmirror69'
        self.QbUnzipMirrorCommand = f'qbunzipmirror69'
        self.QbZipMirrorCommand = f'qbzipmirror69'
